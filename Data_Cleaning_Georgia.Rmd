...
customer_address <- customer_address %>%
  separate("full address", into = c("zip", "city", "state", "state_abbr", "county", "region", "lat", "lon"), sep = ",", convert = TRUE)
```
...
customers_by_group <- joined_data_with_cost %>%
  ...
  mutate(num_customers = n()) %>% # Adds a column to the original data set respecting the grouping
